// ======================================================================
// \title  GdsBridgeTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef GDSBRIDGE_GDSBRIDGETOPOLOGY_HPP
#define GDSBRIDGE_GDSBRIDGETOPOLOGY_HPP
// Included for access to GdsBridge::TopologyState and GdsBridge::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <GdsBridge/Top/GdsBridgeTopologyDefs.hpp>
 ...
 * GdsBridge::TopologyState see: GdsBridgeTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type FprimeGds::TopologyState see: FprimeGdsTopologyDefs.hpp.
 *
