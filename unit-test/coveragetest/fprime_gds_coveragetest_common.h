 ...
 * @file
 *
 * Common definitions for all fprime_gds coverage tests
 */

#ifndef FPRIME_GDS_COVERAGETEST_COMMON_H
#define FPRIME_GDS_COVERAGETEST_COMMON_H
...
#endif /* FPRIME_GDS_COVERAGETEST_COMMON_H */
